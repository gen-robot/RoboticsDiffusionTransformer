    ...
    for epoch in range(first_epoch, args.num_train_epochs):
        ...
        for batch in train_dataloader:
            ...
            logs = {
                ...
                "detail/avg_ref_mse": info["avg_ref_mse"].detach().item(),
                "detail/model_loss_w": info["model_loss_w"].detach().item(),
                "detail/model_loss_l": info["model_loss_l"].detach().item(),
                "detail/ref_loss_w": info["ref_loss_w"].detach().item(),
                "detail/ref_loss_l": info["ref_loss_l"].detach().item(),
                "detail/model_diff": info["model_diff"].detach().item(),
                "detail/ref_diff": info["ref_diff"].detach().item(),
                "detail/w_diff": info["w_diff"].detach().item(),
                "detail/l_diff": info["l_diff"].detach().item(),
            }
