...
class HDF5VLAPairDataset:
    ...
    """
    def __init__(self, recompute_normalization=False):
        ...
        for task in self.tasks:
            ...
            with h5py.File(file_path, "r") as f:
                ...
                for traj in trajs:
                    ...
                    bad_actions = f[traj]['low_actions'][:]

                    states = states[1:]
                    actions = actions[1:]
                    bad_actions = bad_actions[1:]

                    self.state.append(states)
                    self.action.append(actions)
                    self.bad_action.append(bad_actions)
    ...
    def parse_hdf5_file(self, index):
        ...
        bad_actions = (self.bad_action[index] - self.action_min) / (self.action_max - self.action_min) * 2 - 1
        ...
        bad_action_sequence = bad_actions[step_index]
        ...
        bad_action_sequence = fill_in_state(bad_action_sequence)
        ...
        return True, {
            ...
            "bad_actions": bad_action_sequence,
...
if __name__ == "__main__":
    ...
    for i in range(10):
        ...
        print("Action:", sample['actions'])
        print("Bad action:", sample['bad_actions'])
