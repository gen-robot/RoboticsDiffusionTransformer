...
class RoboticDiffusionTransformerModel(object):
    ...
    def __init__(
        ...
        self.state_min = torch.tensor(DATA_STAT[type]['state_min']).to(device)
        self.state_max = torch.tensor(DATA_STAT[type]['state_max']).to(device)
        self.action_min = torch.tensor(DATA_STAT[type]['action_min']).to(device)
        self.action_max = torch.tensor(DATA_STAT[type]['action_max']).to(device)
