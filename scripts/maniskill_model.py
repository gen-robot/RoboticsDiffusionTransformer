...
original = {'state_min': [-0.7463043928146362, -0.0801204964518547, -0.4976441562175751, -2.657780647277832, -0.5742632150650024, 1.8309762477874756, -2.2423808574676514, 0.0], 
...
mix = {'state_min': [-1.0820189714431763, -0.0801204964518547, -0.710361659526825, -2.680790901184082, -0.93064284324646, 1.8309762477874756, -2.897305727005005, 0.0], 
       'state_max': [0.8678459525108337, 1.4967026710510254, 0.8087663054466248, -0.3866899907588959, 0.7189599275588989, 3.2900545597076416, 2.7208492755889893, 0.03999999910593033], 
       'action_min': [-1.081897497177124, -0.08631071448326111, -0.7223370671272278, -2.6835038661956787, -0.929198145866394, 1.8290787935256958, -4.564383029937744, -1.0234375], 
       'action_max': [0.8801185488700867, 1.4984270334243774, 0.800356924533844, -0.38181185722351074, 0.7255510687828064, 3.291581630706787, 2.728142023086548, 1.03125]}

only_correction = {'state_min': [-1.1058704853057861, -0.0801204964518547, -0.7586485147476196, -2.680790901184082, -0.9374275207519531, 1.8309762477874756, -2.8973050117492676, 0.0], 
                   'state_max': [1.111598253250122, 1.4967026710510254, 0.7995014786720276, -0.3866899907588959, 0.8758682608604431, 3.2900545597076416, 2.770939588546753, 0.03999999910593033], 
                   'action_min': [-1.106164574623108, -0.08631071448326111, -0.7685484290122986, -2.6835038661956787, -0.9394499659538269, 1.8290787935256958, -4.572417259216309, -1.0], 
                   'action_max': [1.122759222984314, 1.4984270334243774, 0.800356924533844, -0.38181185722351074, 0.877225399017334, 3.291581630706787, 2.8154571056365967, 1.0]}

all = {'state_min': [-1.1058704853057861, -0.0801204964518547, -0.7586485147476196, -2.680790901184082, -0.9374275207519531, 1.8309762477874756, -2.897305727005005, 0.0], 
       'state_max': [1.111598253250122, 1.4967026710510254, 0.8087663054466248, -0.3866899907588959, 0.8758682608604431, 3.2900545597076416, 2.770939588546753, 0.03999999910593033], 
       'action_min': [-1.106164574623108, -0.08631071448326111, -0.7685484290122986, -2.6835038661956787, -0.9394499659538269, 1.8290787935256958, -4.572417259216309, -1.0234375], 
       'action_max': [1.122759222984314, 1.4984270334243774, 0.800356924533844, -0.38181185722351074, 0.877225399017334, 3.291581630706787, 2.8154571056365967, 1.03125]}
...
class RoboticDiffusionTransformerModel(object):
    ...
    def __init__(
        ...
        self.state_min = torch.tensor(DATA_STAT[stat_type]['state_min']).to(device)
        self.state_max = torch.tensor(DATA_STAT[stat_type]['state_max']).to(device)
        self.action_min = torch.tensor(DATA_STAT[stat_type]['action_min']).to(device)
        self.action_max = torch.tensor(DATA_STAT[stat_type]['action_max']).to(device)
